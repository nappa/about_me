...
- チームに権限を委譲し、チームの学習と成長をサポートし、チームの判断を尊重します。システムを安定して動かしつづけるということも含めてチームに大きな責任を持ってもらえるように体制を作ります。
...
2024年12月以降は特別なプロジェクトに可能な限り専念するようにしています。  
なるべくミーティングは入れないようにお願いします。

## オフィスアワー

平日に1時間だけの「オフィスアワー」という時間を設定しています。(2024/12〜)  
相談したいことは、なるべく、その時間にまとめて入れてください。  
連続した集中時間を確保するために御協力をお願いします。  
緊急の場合はその限りではありません。
...
集中時間を確保するため、現在は 1on1 は実施しておりません。  
...
ひとつのことを深くずっと考え続けることができます。ひとつのバグを何ヶ月間もかけて追いつづけることもあります。
