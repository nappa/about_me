...
私は、一旦はプログラマとして現役であることをあきらめたほどの、ひどい腱鞘炎持ちです。
最近は落ち着いていますが、オーバーワークの後はキーボード・マウスから手を離すため、一時的にスマートフォンを使って業務をすることがあります。フリック入力と音声入力のおかげでプログラマとしての寿命が延びたと思っています。スマートフォンをいじくっているときにはそういうことをしていると思ってください。
...
とはいえ過去は過去、現在は現在、未来は未来です。これまでやってきたことは参考にしないほうがいいと思います。

## コンピュータとのかかわり
- 初めてさわったプログラミング言語は BASIC (シャープのポケコン) (小学校5年生)
  - メモリは32KB。単4電池4個で動くお化けでした。なつかしい。
- Windows 95 に初めて触ったのは1996年2月(小学校5年生)
- インターネットに初めて触ったのは1997年3月(小学校6年生)
  - 通信速度は 28,800bps でした。それでも楽しかったです。
  - その年に HTML 4.0 が出て、仕様書をがんばって読んだりしてました。
- 初めてのLinuxは2000年3月 (高校入学直前)
  - Linux Kernel 2.2 でした。なつかしいですね。
  - 自宅サーバ立てて遊んだりしてました。
- 初めてのRubyは2000年、バージョン1.4 (高校1年生)
  - いまは Ruby の本はいろいろありますが、当時は1冊だけでした。
- 初めてのMySQLは2001年、バージョン3 (高校2年生)
  - InnoDB がありませんでした。ロックはテーブル単位。トランザクションはありませんでした。
